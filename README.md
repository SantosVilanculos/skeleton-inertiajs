[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/santosvilanculos/skeleton-inertiajs/test.yml?label=test)](https://github.com/SantosVilanculos/skeleton-inertiajs/actions)
